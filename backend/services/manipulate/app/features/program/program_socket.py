...
async def on_call_resume(data: Request_ResumePD, robot_model: str):
    ...
    return to_json(await program_service.call_resume(robot_model=robot_model, request=dict_data))


@program_socket_router.on("{robot_model}/call_pause")
async def on_call_pause(data: Request_PausePD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_pause(robot_model=robot_model, request=dict_data))


@program_socket_router.on("{robot_model}/call_halt")
async def on_call_halt(data: Request_MotionHaltPD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_halt(robot_model=robot_model, request=dict_data))
...
async def on_call_move_jb_clr(data: Request_MoveJBClrPD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_move_jb_clr(robot_model=robot_model, request=dict_data))
...
async def on_call_move_jb_run(data: Request_MoveJBRunPD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_move_jb_run(robot_model=robot_model, request=dict_data))
...
async def on_call_move_lb_clr(data: Request_MoveLBClrPD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_move_lb_clr(robot_model=robot_model, request=dict_data))
...
async def on_call_move_xb_clr(data: Request_MoveXBClrPD, robot_model: str):
    dict_data = t_to_dict(data)
    return to_json(await program_service.call_move_xb_clr(robot_model=robot_model, request=dict_data))
