...
from app.features.network.schema.network_dto import Response_Network_GetNetwork, Request_Network_ConnectWifi, Request_Network_GetWifiList, Request_Network_SetPD, Response_Network_ConnectWifi, Response_Network_GetWifiList, Response_Network_SetPD
...
async def get_network() -> Response_Network_GetNetwork:
    """
