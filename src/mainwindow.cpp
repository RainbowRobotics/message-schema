...
#define SAFETY_LED_OFF 0
#define SAFETY_LED_RED 9
#define SAFETY_LED_GREEN_BLINKING 1
#define SAFETY_LED_CYAN 1
#define SAFETY_LED_PURPLE 1
#define SAFETY_LED_PURPLE_BLINKING 1
#define SAFETY_LED_YELLOW 5
#define SAFETY_LED_YELLOW_WAVERING 5
#define SAFETY_LED_YELLOW_FADE 5
#define SAFETY_LED_YELLOW_BLINKING 5
#define SAFETY_LED_PURPLE_YELLOW 1
#define SAFETY_LED_BLUE 2
#define SAFETY_LED_BLUE_WAVERING 2
#define SAFETY_LED_CONTRACTING_GREEN 2
#define SAFETY_LED_WHITE_WAVERING 2
#define SAFETY_LED_WHITE 2
namespace 
{
