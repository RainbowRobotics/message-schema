...
ERROR_MANAGER::ErrorInfo ERROR_MANAGER::getErrorInfo(ErrorCause cause, ErrorContext context)
{
    ...
    case MAP_UNKNOWN_ERROR:         // 0x1006
        {
            info.error_code = "R0Mx" + info.alarm_code;
            info.message = "unknown map error";
            info.solution = "Contact system administrator required";
            info.description = "Unknown map error";
            info.level = "error";
            info.remark = "Map error";
            break;
        }
    case MAP_SAVE_FAIL_CSV:        // 0x1007
        {
            info.error_code = "R0Mx" + info.alarm_code;
            info.message = "map save failed (csv)";
            info.solution = "Check storage space required";
            info.description = "Map save to CSV failed";
            info.level = "warn";
            info.remark = "Storage error";
            break;
        }
    case MAP_LOAD_INVALID_DIR:     // 0x1008
        {
            info.error_code = "R0Mx" + info.alarm_code;
            info.message = "invalid map dir";
            info.solution = "Check map path required";
    ...
    case MOVE_INIT_CONDITION_FAILED: // 0x3007
        {
            info.error_code = "R0Nx" + info.alarm_code;
            info.message = "move init condition failed";
            info.solution = "Check system status required";
            info.description = "Move initialization condition failed";
            info.level = "error";
            info.remark = "Move command rejected";
            break;
        }
    case MOVE_TARGET_NOT_SUPPORTED_MULTI: // 0x3008
        {
            info.error_code = "R0Nx" + info.alarm_code;
    ...
    case MOVE_TARGET_OUT_OF_RANGE: // 0x3009
        {
            info.error_code = "R0Nx" + info.alarm_code;
            info.message = "target location out of range";
            info.solution = "Reset target position required";
    ...
    case MOVE_TARGET_OCCUPIED_STATIC_OBS: // 0x3010
        {
            info.error_code = "R0Nx" + info.alarm_code;
            info.message = "target location occupied by static obstacle";
            info.solution = "Change target position required";
            info.description = "Target position conflicts with static obstacle";
            info.level = "error";
            info.remark = "Target position collision";
    ...
    case MOVE_METHOD_NOT_SUPPORTED: // 0x3011
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "not supported";
            info.solution = "Use supported method required";
            info.description = "Unsupported move method";
            info.level = "warn";
            info.remark = "Method limitation";
            break;
        }
    case MOVE_UNKNOWN_ERROR: // 0x3012
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "unknown move error";
            info.solution = "Contact system administrator required";
            info.description = "Unknown move error";
            info.level = "error";
            info.remark = "Move error";
            break;
        }
    ...
    case SYS_NOT_READY:             // 0x5006
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "system not ready";
            info.solution = "Check system status required";
            info.description = "System not ready for operation";
            info.level = "error";
            info.remark = "Operation unavailable";
            break;
        }
    case SYS_UNKNOWN_ERROR:        // 0x5007
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "unknown system error";
            info.solution = "Contact system administrator required";
            info.description = "Unknown system error";
            info.level = "error";
            info.remark = "System error";
            break;
        }
    case SYS_CONFIG_ERROR:        // 0x5008
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "system configuration error";
            info.solution = "Check system configuration required";
            info.description = "System configuration error";
            info.level = "error";
            info.remark = "Configuration error";
            break;
        }
    ...
    case SAFETY_FIELD_ERROR:        // 0x6006
        {
            info.error_code = "R0Sx" + info.alarm_code;
            info.message = "safety field error";
            info.solution = "Check safety field system required";
            info.description = "Safety field error";
            info.level = "error";
            info.remark = "Safety field malfunction";
            break;
        }
    ...
    case MSA_UNKNOWN_ERROR:        // 0xC005
        {
            info.error_code = "R0Ax" + info.alarm_code;
            info.message = "unknown MSA error";
            info.solution = "Contact system administrator required";
            info.description = "Unknown MSA error";
            info.level = "error";
            info.remark = "MSA error";
            break;
        }
    
    case PROFILE_MOVE_X_INVALID_TARGET_SPEED: // 0xD001
        {
            info.error_code = "R0Px" + info.alarm_code; // P: Profile
            info.message = "invalid target speed in move profile";
            info.solution = "Set valid target speed required";
            info.description = "Target speed in move profile is invalid";
            info.level = "error";
            info.remark = "Profile configuration error";
            break;
        }
    case PROFILE_MOVE_Y_INVALID_TARGET_SPEED: // 0xD002
        {
            info.error_code = "R0Px" + info.alarm_code;
            info.message = "invalid target speed in move profile";
            info.solution = "Set valid target speed required";
            info.description = "Target speed in move profile is invalid";
            info.level = "error";
    ...
    case PROFILE_MOVE_CIRCLE_INVALID_TARGET_SPEED: // 0xD003
        {
            info.error_code = "R0Px" + info.alarm_code;
            info.message = "invalid target speed in move profile";
            info.solution = "Set valid target speed required";
    ...
    case PROFILE_MOVE_ROTATE_INVALID_TARGET_SPEED: // 0xD004
        {
            info.error_code = "R0Px" + info.alarm_code;
            info.message = "invalid target speed in move profile";
            info.solution = "Set valid target speed required";
...
QString ERROR_MANAGER::getCauseName(ErrorCause cause)
{
    switch(cause)
    {
        ...
        case MOVE_INIT_CONDITION_FAILED:        return "Move Init Condition Failed";
        case MOVE_TARGET_NOT_SUPPORTED_MULTI:   return "Target Command Not Supported in Multi-Robot Mode";
        case MOVE_TARGET_OUT_OF_RANGE:          return "Target Out of Range";
        case MOVE_TARGET_OCCUPIED_STATIC_OBS:   return "Target Position Occupied by Static Obstacle";
        case MOVE_METHOD_NOT_SUPPORTED:         return "Move Method Not Supported";
        ...
        case SYS_NOT_READY:                     return "System Not Ready";
        case SYS_UNKNOWN_ERROR:                 return "Unknown System Error";
        case SYS_CONFIG_ERROR:                  return "System Configuration Error";
        ...
        case SAFETY_FIELD_ERROR:                return "Safety Field Error";
        ...
        case MSA_CONNECTION_FAILED:             return "MSA Connection Failed";
        case MSA_TIMEOUT:                       return "MSA Timeout";
        case MSA_INVALID_MESSAGE:               return "MSA Invalid Message";
        case MSA_RESPONSE_ERROR:                return "MSA Response Error";
        case MSA_UNKNOWN_ERROR:                 return "MSA Unknown Error";
        ...
        case COBOT2_CONNECTION_FAILED:          return "Cobot2 Connection Failed";
        case COBOT2_COMMAND_FAILED:             return "Cobot2 Command Failed";
        case COBOT2_STATUS_ERROR:               return "Cobot2 Status Error";
        case COBOT2_EMERGENCY_STOP:             return "Cobot2 Emergency Stop";
        case COBOT2_TIMEOUT:                    return "Cobot2 Timeout";

        case PROFILE_MOVE_X_INVALID_TARGET_SPEED:   return "Profile Move Invalid Target Speed";
        case PROFILE_MOVE_Y_INVALID_TARGET_SPEED:   return "Profile Move Invalid Target Speed";
        case PROFILE_MOVE_CIRCLE_INVALID_TARGET_SPEED:   return "Profile Move Invalid Target Speed";
        case PROFILE_MOVE_ROTATE_INVALID_TARGET_SPEED:   return "Profile Move Invalid Target Speed";
...
QString ERROR_MANAGER::getContextName(ErrorContext context)
{
    switch(context)
    {
        ...
        case MOVE_PROFILE:          return "MOVE_PROFILE";
        case MOVE_STOP:             return "MOVE_STOP";
        ...
        case MSA_COMMUNICATION:      return "MSA_COMMUNICATION";

        case COBOT1_OPERATION:       return "COBOT1_OPERATION";
        case COBOT2_OPERATION:       return "COBOT2_OPERATION";
...
ERROR_MANAGER::ErrorCause ERROR_MANAGER::findErrorCauseFromMessage(const QString& message)
{
    ...
    // Cobot2
    else if(message.contains("[R0CxB001]") || message.contains("B001"))
    {
        return COBOT2_CONNECTION_FAILED;
    }
    else if(message.contains("[R0CxB002]") || message.contains("B002"))
    {
        return COBOT2_COMMAND_FAILED;
    }
    else if(message.contains("[R0CxB003]") || message.contains("B003"))
    {
        return COBOT2_STATUS_ERROR;
    }
    else if(message.contains("[R0CxB004]") || message.contains("B004"))
    {
        return COBOT2_EMERGENCY_STOP;
    }
    else if(message.contains("[R0CxB005]") || message.contains("B005"))
    {   
        return COBOT2_TIMEOUT;
    }

    // MSA
    else if(message.contains("[R0CxC001]") || message.contains("C001"))
    {
        return MSA_CONNECTION_FAILED;
    }
    else if(message.contains("[R0CxC002]") || message.contains("C002"))
    {
        return MSA_TIMEOUT;
    }
    else if(message.contains("[R0CxC003]") || message.contains("C003"))
    {
        return MSA_INVALID_MESSAGE;
    }
    else if(message.contains("[R0CxC004]") || message.contains("C004"))
    {
        return MSA_RESPONSE_ERROR;
    }

    // Profile move
    else if(message.contains("[R0PxD001]") || message.contains("D001"))
    {
        return PROFILE_MOVE_X_INVALID_TARGET_SPEED;
    }
    else if(message.contains("[R0PxD002]") || message.contains("D002"))
    {
        return PROFILE_MOVE_Y_INVALID_TARGET_SPEED;
    }
    else if(message.contains("[R0PxD003]") || message.contains("D003"))
    {
        return PROFILE_MOVE_CIRCLE_INVALID_TARGET_SPEED;
    }
    else if(message.contains("[R0PxD004]") || message.contains("D004"))
    {
        return PROFILE_MOVE_ROTATE_INVALID_TARGET_SPEED;
    }
